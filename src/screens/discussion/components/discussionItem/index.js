...
export default function DiscussionItem({ discussion = {}, expanded, setexpanded }) {
    ...
    <>
      ...
      <Card sx={styles.main}>
        ...
        >
          ...
          <Stack direction={'row'} alignItems='center'>
            <IconButton aria-label="comment" onClick={() => setexpanded(_id == expanded ? null : _id)} >
        ...
        <Collapse in={_id == expanded} timeout="auto" unmountOnExit>
